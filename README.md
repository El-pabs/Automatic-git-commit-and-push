...
- [Git](https://git-scm.com/book/fr/v2/D%C3%A9marrage-rapide-Installation-de-Git) installé et configuré avec votre dépôt GitHub [Comment créer un repo git](https://www.atlassian.com/git/tutorials/setting-up-a-repository).
